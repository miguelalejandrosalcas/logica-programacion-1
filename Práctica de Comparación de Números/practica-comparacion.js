...
if (numero1 === numero2 && numero2 === numero3) {
    ...
    formaAsc.textContent = `De mayor a menor ${numero3}, ${numero1}, ${numero2}`;
    formaDesc.textContent = `De menor a mayor ${numero2}, ${numero1}, ${numero3}`;
} else if (numero1 >= numero3 && numero3 >= numero2){
    formaAsc.textContent = `De mayor a menor ${numero1}, ${numero3}, ${numero2}`;
    formaDesc.textContent = `De menor a mayor ${numero2}, ${numero3}, ${numero1}`;
}
